namespace IntoItIf.Ef.Repositories
{
      ...
      where T : class
   {
      ...
      public EfRepository(ItsDbContext dataContext) : base(dataContext)
      {
         ItsDbContext = dataContext;
      }

      public EfRepository(ItsDbContext dataContext, IQueryable<T> customQuery) : base(
         dataContext,
         customQuery)
      {
         ItsDbContext = dataContext;
      ...
      private ItsDbContext ItsDbContext { get; }
      ...
      public override async Task<Dictionary<string, object>> AddAsync(
         T entity,
      ...
      public override async Task<Dictionary<string, object>> ChangeAsync(
         T entity,
         Func<T, string> existMessageFunc,
         CancellationToken ctok)
      {
      ...
      public Task<List<KeyValue>> GetLookupsAsync(
         ...
         CancellationToken ctok)
      {
         return GetLookupsAsync(idProperty, valueProperty, useValueAsId, include: null, disableTracking: disableTracking, ctok);
      }
      ...
      public IPaged<T> GetPaged(
         ...
         bool disableTracking)
      {
         return GetPaged(searchFields, pageIndex, pageSize, sorts, keyword, PageIndexFrom.Zero, predicate, include, disableTracking);
      }
      ...
      public IPaged<T> GetPaged(
         ...
         bool disableTracking)
      {
         return GetPaged(searchFields, pageIndex, pageSize, sorts, keyword, PageIndexFrom.Zero, null, include, disableTracking);
      }
      ...
      public IPaged<T> GetPaged(
         ...
         bool disableTracking)
      {
         return GetPaged(searchFields, pageIndex, pageSize, sorts, keyword, PageIndexFrom.Zero, predicate, disableTracking);
      }
