...
namespace IntoItIf.Ef.Helpers
{
   ...
   internal static class EfDbContextKeys
   {
      ...
      {
         return dbContext.GetIndexedProperties(typeof(T), true);
      }

      internal static IEnumerable<PropertyInfo> GetPrimaryKeyProperties<T>(this DbContext dbContext)
         where T : class
      {
         return dbContext.GetPrimaryKeyProperties(typeof(T));
      }
      ...
      private static IEnumerable<PropertyInfo> GetIndexedProperties<T>(
         ...
         where T : class
      {
         return dbContext.GetIndexedProperties(typeof(T), uniqueIndexOnly);
      }
