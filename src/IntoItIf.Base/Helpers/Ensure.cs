namespace IntoItIf.Base.Helpers
{
   ...
   public static class Ensure
   {
      ...
      public static T IsBetween<T>(T value, T min, T max, string paramName)
      ...
      public static T IsEqualTo<T>(T value, T comparand, string paramName)
      {
         if (!value.Equals(comparand))
            throw new ArgumentException(string.Format("Value is not equal to {1}: {0}.", value, comparand), paramName);
         return value;
      }
      ...
      /// <param name="paramName">The name of the parameter.</param>
      /// <returns>The value of the parameter.</returns>
      public static T IsGreaterThanOrEqualTo<T>(T value, T comparand, string paramName)
         where T : IComparable<T>
      {
      ...
      /// <param name="paramName">The name of the parameter.</param>
      /// <returns>The value of the parameter.</returns>
      public static T IsNull<T>(T value, string paramName)
         where T : class
      {
         if (value != null)
