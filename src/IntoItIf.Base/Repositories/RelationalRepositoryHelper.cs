namespace IntoItIf.Base.Repositories
{
   ...
   public static class RelationalRepositoryHelper<T>
      where T : class
   {
      #region Public Methods and Operators

      public static string[] GetKeyPropertyNamesInBetween(
      ...
      public static (T MatchValidatedEntity, string[] PropertyNames, bool Found, T InputEntity)
      ...
      public static bool IfCreateError(
      ...
      public static bool IfUpdateError(
