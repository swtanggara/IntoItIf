namespace IntoItIf.Tests.MongoDb
{
   ...
   public class ClientTest
   {
      ...
      [Fact]
      public void ShouldConsumerConnect()
      {
         ITransactionUow uow = new MongoUow(_context);
         var args = new Consumer("GR", "Golden Rama", "client-cre-opsbos-gr");
         var result = uow.GetRepository<MongoRepository<Consumer>, Consumer>()
      ...
      public void ShouldPnrConnect()
      {
         ...
         var result = uow.GetRepository<MongoRepository<Pnr>, Pnr>()
            .Combine(args.ToOption())
            .Map(x => (Repo: x.Item1, Args: x.Item2))
            .Map(
               x =>
